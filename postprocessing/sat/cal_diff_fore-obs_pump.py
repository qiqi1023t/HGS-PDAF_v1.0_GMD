...
name_list=[homo_ol_file,hete_ol_file,homo_hs_h_file,hete_hs_h_file,homo_hs_hs_file,hete_hs_hs_file,homo_hs_s_file,hete_hs_s_file,homo_hsk_hs_file,hete_hsk_hs_file,homo_hsk_h_file,hete_hsk_h_file,homo_hsk_s_file,hete_hsk_s_file]


# observations
obs_file='/p/project/cjicg41/jicg4139/input_HGS-PDAF/observation/obs_SAT.nc'
...
for file_name in name_list:
  ...
  for j in range(0,nobs):
    obs1=obs_data.variables['Saturation'][0:15,j]
    sim1=fore.variables['sat_f'][0:15,id_obs[j]-1]
    obs2=obs_data.variables['Saturation'][64:95,j]
    sim2=fore.variables['sat_f'][64:95,id_obs[j]-1]
    obs[0:15]=obs1
    obs[15:46]=obs2
    sim[0:15]=sim1
    sim[15:46]=sim2
