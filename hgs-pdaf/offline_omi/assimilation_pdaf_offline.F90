...
! !USES:
  ...
  USE mod_assim_pdaf, & ! airables for assimilation
       ONLY: filtertype, istep, istep_asml
...
! *** for the offline mode.                              ***
  ...
  IF (filtertype == 8) THEN
     ...
     write(*,*) 'calling PDAFomi_put_state for localized EnKF'
  ...
  ELSE
     ...
     IF (localfilter==1) THEN
        write(*,*) 'calling PDAFomi_put_state for localized filter'
     ...
     ELSE
        write(*,*) 'calling PDAFomi_put_state for global filter'
